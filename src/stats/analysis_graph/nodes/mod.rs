...
use crate::stats::calculators::{
    ...
    BallThirdCalculator, BeatenToBallCalculator, BoostCalculator, BumpCalculator,
    ...
    PassCalculator, PassingGoalCalculator, PlayerControlState, PlayerFrameState,
...
pub(crate) mod pass;
pub(crate) mod player_control_state;
...
#[allow(unused_imports)]
pub use beaten_to_ball::BeatenToBallNode;
#[allow(unused_imports)]
...
#[allow(unused_imports)]
pub use threat_features::ThreatFeaturesNode;
#[allow(unused_imports)]
...
pub(crate) fn player_control_state_dependency() -> AnalysisDependency {
    AnalysisDependency::with_default::<PlayerControlState>(player_control_state::boxed_default)
}
...
pub(crate) fn ceiling_shot_goal_dependency() -> AnalysisDependency {
    AnalysisDependency::with_default::<CeilingShotGoalCalculator>(
        goal_tags::boxed_ceiling_shot_goal,
    )
}
...
pub(crate) fn flip_into_ball_goal_dependency() -> AnalysisDependency {
    AnalysisDependency::with_default::<FlipIntoBallGoalCalculator>(
        goal_tags::boxed_flip_into_ball_goal,
    )
}
...
pub(crate) fn threat_features_dependency() -> AnalysisDependency {
    AnalysisDependency::with_default::<ThreatFeaturesState>(threat_features::boxed_default)
}
...
pub(crate) fn beaten_to_ball_dependency() -> AnalysisDependency {
    AnalysisDependency::with_default::<BeatenToBallCalculator>(beaten_to_ball::boxed_default)
}
