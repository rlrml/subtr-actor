...
impl BoostCalculator {
    ...
    pub(super) fn inferred_pickup_pad_size(&self, event: &PendingBoostPickupEvent) -> BoostPadSize {
    ...
    pub(super) fn resolve_inferred_pickup(
        &mut self,
        event: PendingBoostPickupEvent,
    ...
    pub(super) fn flush_stale_pickup_comparisons(&mut self, frame: &FrameInfo) {
        while self
            .pending_inferred_pickups
            .front()
