...
define_stats_event!(
    ...
    "Threat Episode",
    EventCategory::Other,
    summary = "A contiguous span where one team's continuous threat value exceeds the episode threshold; its xG is the span's peak value, credited to the attacking team's most recent toucher.",
    approach = [
