...
const FIFTY_FIFTY_TOUCH_DODGE_STATE_LABELS: [StatLabel; 2] = [
    StatLabel::new("dodge_state", "no_dodge"),
    StatLabel::new("dodge_state", "dodge"),
];
const FIFTY_FIFTY_TEAM_ZERO_DODGE_STATE_LABELS: [StatLabel; 2] = [
    StatLabel::new("team_zero_dodge_state", "no_dodge"),
    StatLabel::new("team_zero_dodge_state", "dodge"),
];
const FIFTY_FIFTY_TEAM_ONE_DODGE_STATE_LABELS: [StatLabel; 2] = [
...
fn fifty_fifty_touch_dodge_state_label(dodge_contact: bool) -> StatLabel {
    if dodge_contact {
        StatLabel::new("dodge_state", "dodge")
    } else {
        StatLabel::new("dodge_state", "no_dodge")
...
fn fifty_fifty_team_zero_dodge_state_label(dodge_contact: bool) -> StatLabel {
    if dodge_contact {
        StatLabel::new("team_zero_dodge_state", "dodge")
    } else {
        StatLabel::new("team_zero_dodge_state", "no_dodge")
...
fn fifty_fifty_team_one_dodge_state_label(dodge_contact: bool) -> StatLabel {
    if dodge_contact {
        StatLabel::new("team_one_dodge_state", "dodge")
    } else {
        StatLabel::new("team_one_dodge_state", "no_dodge")
...
impl FiftyFiftyEvent {
    ...
    fn player_labels(&self, player_team_is_team_0: bool) -> Vec<StatLabel> {
