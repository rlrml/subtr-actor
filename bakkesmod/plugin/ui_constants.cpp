...
constexpr std::array<const char *, 1> GRAPH_EVENT_FIELDS{
    "events",
};
constexpr std::array<const char *, 1> REQUIRED_GRAPH_EVENT_FIELDS{
    "events",
};
...
constexpr std::array<EventFilterOption, 33> EVENT_FILTER_OPTIONS{{
    ...
    {"wall_aerial_shot", "Wall shot", "Mechanics"},
    {"center", "Center", "Basic"},
...
constexpr auto UI_STAT_DEFINITIONS = std::to_array<UiStatDefinition>({
    ...
    {"player:wall_aerial_shot.count", "Wall shots", "Mechanics", true, false, false},
