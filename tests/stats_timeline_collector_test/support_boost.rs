...
fn default_team_stats_snapshot() -> TeamStatsSnapshot {
    TeamStatsSnapshot {
        ...
        kickoff: KickoffTeamStats::default(),
...
fn default_player_stats_snapshot(
    ...
    PlayerStatsSnapshot {
        ...
        kickoff: KickoffPlayerStats::default(),
...
fn empty_stats_timeline_config() -> StatsTimelineConfig {
    StatsTimelineConfig {
        ...
        shadow_defense_max_ball_y: 0.0,
        shadow_defense_min_goal_side_y: 0.0,
        shadow_defense_min_gap: 0.0,
        shadow_defense_max_gap: 0.0,
        shadow_defense_max_lateral_gap: 0.0,
