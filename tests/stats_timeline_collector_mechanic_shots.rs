...
pub fn assert_wall_aerial_events_reconstruct_serialized_partial_sums(
    replay_path: &str,
...
pub fn assert_wall_aerial_shot_events_reconstruct_serialized_partial_sums(
    replay_path: &str,
    timeline: &ReplayStatsTimeline,
) {
...
pub fn assert_ceiling_shot_events_reconstruct_serialized_partial_sums(
    replay_path: &str,
    timeline: &ReplayStatsTimeline,
) {
...
pub fn assert_flick_events_reconstruct_serialized_partial_sums(
    replay_path: &str,
    timeline: &ReplayStatsTimeline,
) {
...
pub fn assert_musty_flick_events_reconstruct_serialized_partial_sums(
    replay_path: &str,
    timeline: &ReplayStatsTimeline,
) {
...
pub fn assert_dodge_reset_events_reconstruct_serialized_partial_sums(
    replay_path: &str,
    timeline: &ReplayStatsTimeline,
) {
