...
fn test_boost_values_change_over_time_new_replay() {
    ...
    let replay_path = "assets/replay-format-2025-06-10-v868-32-net10-replicated-boost.replay";
...
fn test_boost_values_change_over_time_old_replay() {
    ...
    let replay_path = "assets/replay-format-2022-09-29-v868-32-net10-legacy-boost.replay";
