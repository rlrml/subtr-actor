...
- [CHANGELOG.md](./CHANGELOG.md): release history and notable user-visible changes.
...
- [legacy-replay-investigation.md](./legacy-replay-investigation.md): evidence log for legacy rigid-body normalization and replay plausibility probes.
...
- [replay-format-evolution.md](./replay-format-evolution.md): working map of replay-format changes that affect `subtr-actor` physical state normalization.
