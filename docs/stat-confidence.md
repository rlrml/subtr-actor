...
| `whiff.whiff_count`, `whiff.beaten_to_ball_count`, `whiff.grounded_whiff_count`, `whiff.aerial_whiff_count`, `whiff.dodge_whiff_count`, `whiff.is_last_whiff`, `whiff.last_whiff_time`, `whiff.last_whiff_frame`, `whiff.time_since_last_whiff`, `whiff.frames_since_last_whiff`, `whiff.last_closest_approach_distance`, `whiff.best_closest_approach_distance`, `whiff.average_closest_approach_distance` | Inferred from approach, proximity, speed, dodge/aerial state, and touch outcome. A committed approach that ends with an opponent touch is counted as beaten to the ball instead of a whiff. False positives are possible in congested or fake-challenge plays. |
