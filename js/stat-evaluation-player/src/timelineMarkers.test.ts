  ...
  assert.deepEqual(buildWallAerialTimelineEvents(statsTimeline, replay), [
    {
      ...
      frame: 2,
      kind: "wall-aerial",
      label: "Blue wall-to-air setup 86% | right wall",
      shortLabel: "W2A",
      playerId: "Steam:blue-id",
      playerName: "Blue",
      isTeamZero: true,
  ...
  assert.deepEqual(buildWallAerialShotTimelineEvents(statsTimeline, replay), [
    {
      ...
      label: "Blue wall shot 74% | right wall",
      shortLabel: "WS",
      playerId: "Steam:blue-id",
      playerName: "Blue",
      isTeamZero: true,
...
test("buildGoalTagTimelineEvents and buildGoalContextTimelineEvents map goal analysis events", () => {
  ...
  assert.deepEqual(buildGoalTagTimelineEvents(statsTimeline, replay), [
    ...
    {
      id: "goal-tag:0:flip_reset_goal:1",
      time: 1.5,
      frame: 1,
      kind: "goal-tag",
      label: "Blue flip reset assist goal 93%",
      shortLabel: "GT",
      playerId: "Steam:blue-id",
      playerName: "Blue",
      isTeamZero: true,
