...
export function renderRelativePositioningStats(
  ...
  return `
    <div class="stat-row"><span class="label">Most back</span><span class="value">${formatPercentage(asNumber(positioning?.percent_most_back))}</span></div>
    <div class="stat-row"><span class="label">Most forward</span><span class="value">${formatPercentage(asNumber(positioning?.percent_most_forward))}</span></div>
    <div class="stat-row"><span class="label">Mid role</span><span class="value">${formatPercentage(asNumber(positioning?.percent_mid_role))}</span></div>
    <div class="stat-row"><span class="label">Other role</span><span class="value">${formatPercentage(asNumber(positioning?.percent_other_role))}</span></div>
    <div class="stat-row"><span class="label">Closest to ball</span><span class="value">${formatPercentage(asNumber(positioning?.percent_closest_to_ball))}</span></div>
    <div class="stat-row"><span class="label">Farthest from ball</span><span class="value">${formatPercentage(asNumber(positioning?.percent_farthest_from_ball))}</span></div>
    <div class="stat-row"><span class="label">Behind ball</span><span class="value">${formatPercentage(asNumber(positioning?.percent_behind_ball))}</span></div>
    <div class="stat-row"><span class="label">In front of ball</span><span class="value">${formatPercentage(asNumber(positioning?.percent_in_front_of_ball))}</span></div>
  `;
}
...
export function renderAbsolutePositioningStats(
  ...
  return `
    ...
    <div class="stat-row"><span class="label">To teammates</span><span class="value">${formatNumber(asNumber(positioning?.average_distance_to_teammates), 0)}</span></div>
    <div class="stat-row"><span class="label">To ball</span><span class="value">${formatNumber(asNumber(positioning?.average_distance_to_ball), 0)}</span></div>
  `;
}
