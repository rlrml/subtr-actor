import { getCameraWindowTemplate } from "./appTemplateCamera.ts";
import { getMechanicsReviewWindowTemplates } from "./appTemplateMechanicsReview.ts";
    ...
    <section class="workspace">
      <div class="viewport-panel">
        ...
        <div id="floating-window-layer" class="floating-window-layer">
          ...
          ${getCameraWindowTemplate(defaultCameraDistanceScale)}
          ...
          ${getMechanicsReviewWindowTemplates()}
